...
0 による整数除算では、常に [DivideByZeroException](./../Exceptions.md) がスローされます.
...
`decimal` 型のオペランドの場合、算術オーバーフローでは常に [OverflowException](./../Exceptions.md) がスローされます. 0 による除算では常に [DivideByZeroException](./../Exceptions.md) がスローされます.
